    ...
    <div class="min-h-[80vh] flex items-center justify-center py-12 px-4">
        <div class="max-w-md w-full">
            ...
            <div class="text-center mb-8">
                ...
                <h2 class="mt-4 text-2xl font-heading font-bold text-[#1F2937]">Create Account</h2>
                <p class="mt-2 text-sm text-[#4B5563]">Join our community and start shopping</p>
            </div>
            ...
            <div class="bg-white border border-[#E5E7EB] rounded-2xl shadow-brand p-6 md:p-8">
                ...
                <div class="relative my-6">
                    ...
                    <div class="relative flex justify-center text-sm">
                        <span class="px-4 bg-white text-[#4B5563]">Or register with email</span>
                    </div>
                </div>
                ...
                <form action="{{ route('register.submit') }}" method="POST" class="space-y-4">
                    ...
                    <!-- Full Name -->
                    <div>
                        <label for="name" class="block text-sm font-medium text-[#1F2937] mb-1.5">
                    ...
                    <!-- Password -->
                    <div>
                        <label for="password" class="block text-sm font-medium text-[#1F2937] mb-1.5">
                        ...
                        @error('password')
                            <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                        @enderror
                        <p class="mt-1 text-xs text-[#4B5563]">Must be at least 8 characters with a number and symbol
                        </p>
                    </div>

                    <!-- Confirm Password -->
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-[#1F2937] mb-1.5">
                    ...
                    <div class="flex items-start gap-2 pt-2">
                        <input type="checkbox" id="terms" name="terms" required
                            class="mt-1 w-4 h-4 rounded border-[#E5E7EB] text-[#642671] focus:ring-[#642671]/30 focus:ring-2">
            ...
            <div class="mt-6 grid grid-cols-3 gap-3">
                <div class="text-center bg-white border border-[#E5E7EB] rounded-xl p-3">
                    <i class="fas fa-truck text-[#642671] text-xl mb-1"></i>
                    <p class="text-xs text-[#4B5563]">Free Shipping</p>
                </div>
                <div class="text-center bg-white border border-[#E5E7EB] rounded-xl p-3">
                    <i class="fas fa-shield-alt text-[#642671] text-xl mb-1"></i>
                    <p class="text-xs text-[#4B5563]">Secure Payment</p>
                </div>
                <div class="text-center bg-white border border-[#E5E7EB] rounded-xl p-3">
                    <i class="fas fa-headset text-[#642671] text-xl mb-1"></i>
                    <p class="text-xs text-[#4B5563]">24/7 Support</p>
                </div>
            </div>
        </div>
    </div>
